...
export const validateSignUpRequestBody = (req) => {
  ...
  const validation = [
    {
      valid: firstName.length < 4 || firstName.length > 15,
      message: "firstName must be between 4 to 15 character",
    },
    {
      valid: lastName.length < 4 || lastName.length > 15,
      message: "lastName must be between 4 to 15 character",
    },
    {
    ...
    },
    {
      ...
      message: `age must be between 18 to 100: ${age}`,
    },
    {
      valid: !allowedGenders.includes(gender),
      message: `gender is invalid: ${gender}`,
    },
    {
    ...
    {
      valid: skills.length > 5,
      message: `skills length exceeds 5`,
    },
  ];
...
export const validateEditRequestBody = (req) => {
  ...
  const validation = [
    ...
    },
    {
      ...
      message: `atleast one skill required`,
    },
    {
      valid: skills.length > 5,
      message: `skills length exceeds 5`,
  ...
  const validation = [
    {
      ...
      message:
        "newPassword should contain at least one number, one uppercase and lowercase letter, one special character",
    },
    {
